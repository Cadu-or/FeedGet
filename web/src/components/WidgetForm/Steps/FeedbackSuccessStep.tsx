...
interface FeedbackSuccessStepProps {
  onsetFeedbackNull: () => void
}

export function FeedbackSuccessStep({onsetFeedbackNull}: FeedbackSuccessStepProps) {
  return (
    <>
      <header>
        <CloseButton />
